...
export function CrossIcon({ size = 20, color = 'currentColor' }) {
  return (
...
export function PCUSeal({ size = 36, color = '#b8922a' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 36 36" fill="none">
      <circle cx="18" cy="18" r="16" stroke={color} strokeWidth="1.2" fill="none"/>
      <circle cx="18" cy="18" r="12" stroke={color} strokeWidth="0.6" fill="none" opacity="0.5"/>
      <path d="M18 8 L20 15 L27 15 L21 19 L23 26 L18 22 L13 26 L15 19 L9 15 L16 15 Z" fill={color} opacity="0.7"/>
    </svg>
  );
}
